  ...
  return (
    <section id="home" className="font-sans flex flex-col md:flex-row items-center justify-center py-16 sm:py-20 px-4 sm:px-6 bg-black relative overflow-hidden">
      <div className="flex-1 text-center md:text-left md:ml-20">
        <p className="text-yellow-500 text-lg sm:text-xl">HELLO!</p>
        ...
        <p className="mt-4 text-base sm:text-lg md:text-xl text-gray-300">I am a Developer |</p>
        <div className="mt-6">
          <a
            href="#about"
            className="inline-block border border-yellow-500 text-yellow-500 px-6 py-2 rounded-full hover:bg-yellow-600 hover:text-white  transition-all duration-300"
          >
            ABOUT ME
          </a>
        </div>
      ...
      <div className="flex-1 flex justify-center relative mt-10 md:mt-0 md:mr-20">
        <img
          src={mypic}
          alt="profile"
          className="w-60 sm:w-72 md:w-[27.5rem] h-60 sm:h-72 md:h-[27.5rem] rounded-full object-cover animate-float profile-image"
          style={{ ...shadowStyle, ...transformStyle }}
        />
        <div className="mt-6 ml-10">
          <span className="outlined-text absolute bottom-[-2.5rem] text-white text-xl sm:text-2xl md:text-3xl font-bold tracking-wide opacity-50  ">
            SHADA
          </span>
        </div>
      </div>
